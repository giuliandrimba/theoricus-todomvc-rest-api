...
(function() {
  ...
  Todos = (function() {
    ...
    Todos.prototype.read = function(req, res) {
      ...
      return this.db.read(id, function(result) {
        return res.send(result);
      });
    };
    ...
    Todos.prototype.create = function(req, res) {
      var todo,
        _this = this;
      todo = req.body;
      return this.db.create(todo, function(result) {
        return res.send(result);
      });
    };
    ...
    Todos.prototype.update = function(req, res) {
      ...
      return this.db.update(id, todo, function(result) {
        return res.send(result);
      });
    };
    ...
    Todos.prototype["delete"] = function(req, res) {
      ...
      return this.db["delete"](id, function(result) {
